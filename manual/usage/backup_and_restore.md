...
When SeaSearch is deployed with an object storage backend, you only need to back up the metadata file.
...
Use the backup data to restore your SeaSearch instance：
